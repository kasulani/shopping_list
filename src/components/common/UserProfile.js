    ...
    <div className="col-md-3"> {/*this the column with the profile picture and about me and it appears on all pages*/}
        ...
        <div className="box box-primary">
          <div className="box-body box-profile">
            ...
            <h3 className="profile-username text-center"><small>{props.username}</small></h3>
            <ul className="list-group list-group-unbordered">
              <li className="list-group-item">
                <b>Shopping Lists</b> <a className="pull-right">{props.lists}</a>
              </li>
              <li className="list-group-item">
                <b>Total Items</b> <a className="pull-right">{props.items}</a>
              </li>
              {/*<li className="list-group-item">
